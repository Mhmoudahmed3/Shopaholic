            ...
            <div className="w-full px-4 sm:px-6 lg:px-8 pb-24 pt-12 lg:pb-16 lg:pt-16">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
                    ...
                    <div className="md:col-span-1">
                        <Link href="/" className="text-xl font-bold tracking-widest uppercase inline-block mb-4">
                            SHOPAHOLIC
                        </Link>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li><Link href="/shop" className="text-sm text-gray-500 hover:text-black dark:text-gray-400 dark:hover:text-white transition-colors">All Products</Link></li>
                            {categories.map((c) => (
                                <li key={c.id}><Link href={`/shop?category=${c.id}`} className="text-sm text-gray-500 hover:text-black dark:text-gray-400 dark:hover:text-white transition-colors capitalize">{c.label}</Link></li>
                            ))}
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li><Link href="/faq" className="text-sm text-gray-500 hover:text-black dark:text-gray-400 dark:hover:text-white transition-colors">FAQ</Link></li>
                    ...
                    <div>
                        ...
                        <form className="flex flex-col sm:flex-row gap-2">
                            <input
                                ...
                                className="w-full px-4 py-2 text-sm border border-gray-200 dark:border-gray-800 bg-transparent focus:outline-none focus:ring-1 focus:ring-black dark:focus:ring-white transition-shadow"
                                required
                            />
                            <button
                                type="submit"
                                className="px-6 py-2 bg-black text-white dark:bg-white dark:text-black text-sm font-medium uppercase tracking-wider hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors whitespace-nowrap"
                            >
                                Subscribe
                            </button>
                        </form>
                ...
                <div className="mt-12 pt-8 border-t border-gray-100 dark:border-gray-800 flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex gap-4">
                        <Link href="/privacy" className="text-xs text-gray-500 hover:text-black dark:text-gray-400 dark:hover:text-white transition-colors">Privacy Policy</Link>
                        <Link href="/terms" className="text-xs text-gray-500 hover:text-black dark:text-gray-400 dark:hover:text-white transition-colors">Terms of Service</Link>
                    </div>
                </div>
